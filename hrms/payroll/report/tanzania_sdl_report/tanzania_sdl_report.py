...
def get_columns():
	return [
		...
		{"label": _("SDL (4.5%)"), "fieldname": "sdl", "fieldtype": "Currency", "width": 130},
...
def get_data(filters):
	...
	sdl_rate = flt(filters.get("sdl_rate") or 4.5) / 100.0

	data = []
	for slip in slips:
		sdl = flt(slip.gross_pay) * sdl_rate
		data.append({
...
def get_summary(data):
	...
	return [
		...
		{"label": _("Total SDL Payable"), "value": sum(r["sdl"] for r in rows), "datatype": "Currency", "indicator": "orange"},
